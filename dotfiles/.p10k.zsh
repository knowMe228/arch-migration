# Generated by Powerlevel10k configuration wizard on 2025-06-25 at 17:12 MSK.
...
# sharp tails, 2 lines, solid, full frame, sparse, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='%F{yellow}[$P9K_IP_IP]%f'
